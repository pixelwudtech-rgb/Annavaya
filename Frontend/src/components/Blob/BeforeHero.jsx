...
export default function ParallaxPremium() {
    ...
    <div className=" text-gray-900 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full z-20 pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/Blob/IMG_2642.PNG')",
  ...
  Grown with Care. Delivered  <br className="hidden md:block" /> with Freshness.
</h1>

<p className="text-white/80 text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed">
  Keerai World brings farm fresh leafy greens and traditional superfoods through
  responsible sourcing and gentle handling. Every harvest reflects our focus on
  purity, nutrition, and consistent freshness supporting healthy cooking and
  everyday wellness you can trust.
</p>
