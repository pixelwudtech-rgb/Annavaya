  ...
  />
      ...
      <div className="relative w-full h-[280px] sm:h-[340px] md:h-[420px] lg:h-[480px]">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1599490659213-e2b9527bd087?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
          }}
        />
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-6">
          <div className="max-w-2xl">
            <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
              Fuel Your Day with Premium Protein
            </h2>

            <p className="mt-4 text-white/90 text-sm sm:text-base">
              Clean ingredients. Powerful nutrition. Designed for everyone.
            </p>

            <button className="mt-6 rounded-full bg-white px-6 py-3 text-sm font-semibold text-black hover:bg-gray-100 transition">
              Shop Now
            </button>
          </div>
        </div>
